...
const Footer = () => {
  return (
    <footer
      className="wow fadeInUp relative z-10 bg-gradient-to-t from-blueo-50 to-acid-50  pt-20 lg:pt-[100px]"
      data-wow-delay=".30s"
    >
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div className="mb-10 w-full">
              ...
              <p className="mb-8 max-w-[270px] text-base text-gray-7">
                Keeping tabs on top-tier investments.
              </p>
      ...
      <div className="mt-4 border-t border-[#8890A4] border-opacity-40 py-4 lg:mt-[60px]">
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
      ...
      <div>
        <span className="absolute left-0 top-0 z-[-1] aspect-[95/82] w-full max-w-[570px] drop-shadow-md">
          <Image src="/images/footer/shape-1.svg" alt="shape" fill />
        </span>

        <span className="absolute top-0 right-0 z-[-1] aspect-[95/82] w-full max-w-[570px] drop-shadow-2xl">
